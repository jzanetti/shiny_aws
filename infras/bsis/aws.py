...
def customized_userdata(workdir: str, cfg: dict) -> str:
...
def create_userdata(workdir: str, cfg: dict) -> str:
    ...
    """
    cloud_init_path = customized_userdata(workdir, cfg)
...
def create_infras(workdir: str, cfg: dict) -> str:
    ...
    user_data = create_userdata(workdir, cfg)
